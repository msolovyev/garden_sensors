...
sensy_boi = minimalmodbus.Instrument('/dev/ttySC0',mb_address)	# Make an "instrument" object called sensy_boi (port name, slave address (in decimal))
...
data =sensy_boi.read_registers(0, 4, 3) 
...
print(f"Illuminance = {lum_int} lux")
print("-------------------------------------")
print("")
